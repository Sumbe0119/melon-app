...
const MongolianMovie = ({navigation}) => {
    return (

            <View style={styles.contain}>
                <SubNavigation  navigation={navigation} back={true} headTitle={'MONGOLIA'}/>
                ...
                <View style={{marginTop: 20, paddingBottom: 40, marginHorizontal: 15}}>
                    <SwiperFlatList autoplay style={{width: screenWidth -30}} autoplayDelay={4} autoplayLoop index={2} showPagination={false}>
                        {
